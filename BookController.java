...
public class BookController 
{
	 BookDAO bdao;
	  ...
	  @GetMapping("/bookCRUD")
	  public String bookCrud(@RequestParam("sub")String sub,@RequestParam("bookid")int bookid,@RequestParam("booktitle")String booktitle,@RequestParam("price")int price,@RequestParam("bookauthor")String author ,RedirectAttributes ra)
	  {
